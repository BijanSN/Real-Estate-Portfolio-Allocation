function [ExchangeDate3,Close] = importfile4(workbookFile,sheetName,startRow,endRow)
%IMPORTFILE4 Import data from a spreadsheet
%   [ExchangeDate3,Close] = IMPORTFILE4(FILE) reads data from the first
%   worksheet in the Microsoft Excel spreadsheet file named FILE and
%   returns the data as column vectors.
%
%   [ExchangeDate3,Close] = IMPORTFILE4(FILE,SHEET) reads from the
%   specified worksheet.
%
%   [ExchangeDate3,Close] = IMPORTFILE4(FILE,SHEET,STARTROW,ENDROW) reads
...
% Example:
%   [ExchangeDate3,Close] = importfile4('re_us.xlsx','Sheet 1',15,114);
%
%   See also XLSREAD.

% Auto-generated by MATLAB on 2019/04/06 13:27:51
...
ExchangeDate3 = datetime([dates{:,1}].', 'ConvertFrom', 'Excel');
Close = data(:,1);

% For code requiring serial dates (datenum) instead of datetime, uncomment
% the following line(s) below to return the imported dates as datenum(s).

% ExchangeDate3=datenum(ExchangeDate3);
