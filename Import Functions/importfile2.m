function [ExchangeDate1,Close] = importfile2(workbookFile,sheetName,startRow,endRow)
%IMPORTFILE2 Import data from a spreadsheet
%   [ExchangeDate1,Close] = IMPORTFILE2(FILE) reads data from the first
%   worksheet in the Microsoft Excel spreadsheet file named FILE and
%   returns the data as column vectors.
%
%   [ExchangeDate1,Close] = IMPORTFILE2(FILE,SHEET) reads from the
%   specified worksheet.
%
%   [ExchangeDate1,Close] = IMPORTFILE2(FILE,SHEET,STARTROW,ENDROW) reads
...
% Example:
%   [ExchangeDate1,Close] = importfile2('RE_CH_TRUE.xlsx','Sheet 1',15,114);
%
%   See also XLSREAD.

% Auto-generated by MATLAB on 2019/04/06 13:14:07
...
ExchangeDate1 = datetime([dates{:,1}].', 'ConvertFrom', 'Excel');
Close = data(:,1);

% For code requiring serial dates (datenum) instead of datetime, uncomment
% the following line(s) below to return the imported dates as datenum(s).

% ExchangeDate1=datenum(ExchangeDate1);
