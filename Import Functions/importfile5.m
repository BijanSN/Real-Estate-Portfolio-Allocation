function [ExchangeDate3,Close] = importfile5(workbookFile,sheetName,startRow,endRow)
%IMPORTFILE5 Import data from a spreadsheet
%   [ExchangeDate3,Close] = IMPORTFILE5(FILE) reads data from the first
%   worksheet in the Microsoft Excel spreadsheet file named FILE and
%   returns the data as column vectors.
%
%   [ExchangeDate3,Close] = IMPORTFILE5(FILE,SHEET) reads from the
%   specified worksheet.
%
%   [ExchangeDate3,Close] = IMPORTFILE5(FILE,SHEET,STARTROW,ENDROW) reads
...
% Example:
%   [ExchangeDate3,Close] = importfile5('re_uk.xlsx','Sheet 1',15,114);
%
%   See also XLSREAD.

% Auto-generated by MATLAB on 2019/04/06 13:29:07
