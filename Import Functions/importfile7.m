function [Date,PX_LAST] = importfile7(workbookFile,sheetName,startRow,endRow)
%IMPORTFILE7 Import data from a spreadsheet
%   [Date,PX_LAST] = IMPORTFILE7(FILE) reads data from the first worksheet
%   in the Microsoft Excel spreadsheet file named FILE and returns the data
%   as column vectors.
%
%   [Date,PX_LAST] = IMPORTFILE7(FILE,SHEET) reads from the specified
%   worksheet.
%
%   [Date,PX_LAST] = IMPORTFILE7(FILE,SHEET,STARTROW,ENDROW) reads from the
...
%
% Example:
%   [Date,PX_LAST] = importfile7('bond CH_gov.xlsx','Worksheet',8,107);
%
%   See also XLSREAD.

% Auto-generated by MATLAB on 2019/04/06 13:44:25
